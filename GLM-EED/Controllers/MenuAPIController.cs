...
namespace GLM_EED.Controllers
{
    public class MenuApiController : ApiController
    {
        Item[] items = new Item[]
        {
            ...
            new Item {Id = 4, Name="Carne de res", UrlPhoto="~/Images/Menu/Items/carne_res.png", Category="Porteinas", Count="Like", Status=true},
            new Item {Id = 5, Name="Jugo de maracuya", UrlPhoto="~/Images/Menu/Items/jugo_maracuya.png", Category="Jugos", Count="Like", Status=true},
            new Item {Id = 6, Name="Pollo", UrlPhoto="~/Images/Menu/Items/pollo.png", Category="Porteinas", Count="Like", Status=true},
            new Item {Id = 7, Name="Jugo de Guayaba", UrlPhoto="~/Images/Menu/Items/jugo_guayaba.png", Category="Jugos", Count="Like", Status=true},
            new Item {Id = 8, Name="Especial", UrlPhoto="~/Images/Menu/Items/especial.png", Category="Especial", Count="Like", Status=true}
        };
